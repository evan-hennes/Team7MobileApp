...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? AIChatPageWidget() : OpenPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: OpenPageWidget.routeName,
          path: OpenPageWidget.routePath,
          builder: (context, params) => OpenPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AIChatPage2Widget.routeName,
          path: AIChatPage2Widget.routePath,
          builder: (context, params) => AIChatPage2Widget(),
        )
